...
!function(t,i){"use strict";"function"==typeof define&&define.amd?define(["classie/classie","eventie/eventie","./flickity","unidragger/unidragger","fizzy-ui-utils/utils"],function(e,r,o,n,s){return i(t,e,r,o,n,s)}):"object"==typeof exports?module.exports=i(t,require("desandro-classie"),require("eventie"),require("./flickity"),require("unidragger"),require("fizzy-ui-utils")):t.Flickity=i(t,t.classie,t.eventie,t.Flickity,t.Unidragger,t.fizzyUIUtils)}(window,function(t,i,e,r,o,n){"use strict";function s(t){t.preventDefault?t.preventDefault():t.returnValue=!1}function a(i){var e=o.getPointerPoint(i);return e.y-t.pageYOffset}n.extend(r.defaults,{draggable:!0,touchVerticalScroll:!0}),r.createMethods.push("_createDrag"),n.extend(r.prototype,o.prototype),r.prototype._createDrag=function(){this.on("activate",this.bindDrag),this.on("uiChange",this._uiChangeDrag),this.on("childUIPointerDown",this._childUIPointerDownDrag),this.on("deactivate",this.unbindDrag)},r.prototype.bindDrag=function(){this.options.draggable&&!this.isDragBound&&(i.add(this.element,"is-draggable"),this.handles=[this.viewport],this.bindHandles(),this.isDragBound=!0)},r.prototype.unbindDrag=function(){this.isDragBound&&(i.remove(this.element,"is-draggable"),this.unbindHandles(),delete this.isDragBound)},r.prototype._uiChangeDrag=function(){delete this.isFreeScrolling},r.prototype._childUIPointerDownDrag=function(t){s(t),this.pointerDownFocus(t)},r.prototype.pointerDown=function(t,e){this._dragPointerDown(t,e);var r=document.activeElement;r&&r.blur&&r!=this.element&&r!=document.body&&r.blur(),this.pointerDownFocus(t),this.dragX=this.x,i.add(this.viewport,"is-pointer-down"),this._bindPostStartEvents(t),this.dispatchEvent("pointerDown",t,[e])};var h={touchstart:!0,MSPointerDown:!0},l={INPUT:!0,SELECT:!0};r.prototype.pointerDownFocus=function(t){!this.options.accessibility||h[t.type]||l[t.target.nodeName]||this.element.focus()},r.prototype.pointerMove=function(t,i){var e=this._dragPointerMove(t,i);this.touchVerticalScrollMove(t,i,e),this._dragMove(t,i,e),this.dispatchEvent("pointerMove",t,[i,e])},r.prototype.hasDragStarted=function(t){return!this.isTouchScrolling&&Math.abs(t.x)>3},r.prototype.pointerUp=function(t,e){delete this.isTouchScrolling,i.remove(this.viewport,"is-pointer-down"),this.dispatchEvent("pointerUp",t,[e]),this._dragPointerUp(t,e)};var c={touchmove:!0,MSPointerMove:!0};return r.prototype.touchVerticalScrollMove=function(i,e,r){var o=this.options.touchVerticalScroll,n="withDrag"==o?!o:this.isDragging||!o;!n&&c[i.type]&&!this.isTouchScrolling&&Math.abs(r.y)>10&&(this.startScrollY=t.pageYOffset,this.pointerWindowStartY=a(e),this.isTouchScrolling=!0)},r.prototype.dragStart=function(t,i){this.dragStartPosition=this.x,this.startAnimation(),this.dispatchEvent("dragStart",t,[i])},r.prototype.dragMove=function(t,i,e){s(t),this.previousDragX=this.dragX;var r=this.options.rightToLeft?-1:1,o=this.dragStartPosition+e.x*r;if(!this.options.wrapAround&&this.cells.length){var n=Math.max(-this.cells[0].target,this.dragStartPosition);o=o>n?.5*(o+n):o;var a=Math.min(-this.getLastCell().target,this.dragStartPosition);o=a>o?.5*(o+a):o}this.dragX=o,this.dragMoveTime=new Date,this.dispatchEvent("dragMove",t,[i,e])},r.prototype.dragEnd=function(t,i){this.options.freeScroll&&(this.isFreeScrolling=!0);var e=this.dragEndRestingSelect();if(this.options.freeScroll&&!this.options.wrapAround){var r=this.getRestingDragPosition();this.isFreeScrolling=-r>this.cells[0].target&&-r<this.getLastCell().target}else this.options.freeScroll||e!=this.selectedIndex||(e+=this.dragEndBoostSelect());delete this.previousDragX,this.select(e),this.dispatchEvent("dragEnd",t,[i])},r.prototype.dragEndRestingSelect=function(){var t=this.getRestingDragPosition(),i=Math.abs(this.getCellDistance(-t,this.selectedIndex)),e=this._getClosestResting(t,i,1),r=this._getClosestResting(t,i,-1),o=e.distance<r.distance?e.index:r.index;return o},r.prototype.getRestingDragPosition=function(){var t=this.dragX-this.x;return this.x+t/(1-this.getFrictionFactor())},r.prototype._getClosestResting=function(t,i,e){for(var r=this.selectedIndex,o=1/0,n=this.options.contain&&!this.options.wrapAround?function(t,i){return i>=t}:function(t,i){return i>t};n(i,o)&&(r+=e,o=i,i=this.getCellDistance(-t,r),null!==i);)i=Math.abs(i);return{distance:o,index:r-e}},r.prototype.getCellDistance=function(t,i){var e=this.cells.length,r=this.options.wrapAround&&e>1,o=r?n.modulo(i,e):i,s=this.cells[o];if(!s)return null;var a=r?this.slideableWidth*Math.floor(i/e):0;return t-(s.target+a)},r.prototype.dragEndBoostSelect=function(){if(void 0===this.previousDragX||!this.dragMoveTime||new Date-this.dragMoveTime>100)return 0;var t=this.getCellDistance(-this.dragX,this.selectedIndex),i=this.previousDragX-this.dragX;return t>0&&i>0?1:0>t&&0>i?-1:0},r.prototype.staticClick=function(t,i){var e=this.getParentCell(t.target),r=e&&e.element,o=e&&n.indexOf(this.cells,e);this.dispatchEvent("staticClick",t,[i,r,o])},r});
